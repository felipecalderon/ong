...
export const metadata: Metadata = {
    title: 'Información y Legislación Animal',
    description: 'Aprende sobre la historia, propuestas actuales y recursos de la legislación animal en Chile.',
}
...
const recursos = [
    {
        title: 'Cómo Ayudar',
        description:
            'Descubre las diferentes maneras en las que puedes apoyar nuestra misión, desde el voluntariado hasta la difusión en redes sociales.',
    ...
    return (
        <main className='container mx-auto px-4 py-12'>
            <section className='text-center mb-16'>
                <h1 className='text-4xl font-bold text-gray-800 dark:text-white mb-4'>Centro de Información</h1>
                <p className='text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                    La educación es clave para construir una comunidad compasiva con los animales. Aquí encontrarás recursos valiosos sobre el marco
                    legal y cómo puedes ayudar.
                </p>
            </section>

            <section className='mt-24 max-w-4xl mx-auto'>
                <h2 className='text-3xl font-bold text-center text-gray-800 dark:text-white mb-12'>Más Recursos</h2>
